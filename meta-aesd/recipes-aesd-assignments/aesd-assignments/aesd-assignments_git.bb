...
SRC_URI = "git://git@github.com/cu-ecen-aeld/assignments-3-and-later-andy314dn;protocol=ssh;branch=fix-assignment-6"

PV = "1.0+git${SRCPV}"
SRCREV = "2a657bf2d84b65af27f3a724cac4466f4029c367"
